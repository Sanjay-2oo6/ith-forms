...
import { i as IthLogo, s as useBranding } from "./_ssr/ith-brand-fcDpoiC6.mjs";
import { l as useLocation } from "./_libs/@tanstack/react-router+[...].mjs";
import { T as LoaderCircle, V as CircleAlert, j as Eye, r as Upload, t as X, w as LogOut, z as CircleCheck } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_slug-CnIf9vPN.js
...
function useAuthSubmissionStatus(formId, email) {
	const [status, setStatus] = (0, import_react.useState)(null);
	const [isLoading, setIsLoading] = (0, import_react.useState)(!formId || !email);
	const [error, setError] = (0, import_react.useState)(null);
	(0, import_react.useEffect)(() => {
		if (!formId || !email) {
			setStatus(null);
	...
	async function fetchSubmissionStatus() {
		...
		try {
			...
			const { data, error: rpcError } = await supabase.rpc("get_submission_count_for_email", {
				p_form_id: formId,
				p_email: email
			});
			if (rpcError) throw new Error(rpcError.message || "Failed to fetch submission status");
...
function PublicForm() {
	...
	const { status: submissionStatus, isLoading: statusLoading } = useAuthSubmissionStatus(form?.id, authSession?.email);
	(0, import_react.useEffect)(() => {
	...
	async function handleGoogleSignIn() {
		try {
			...
			await supabase.auth.signInWithOAuth({
				provider: "google",
				options: { redirectTo: `${typeof window !== "undefined" ? window.location.origin : ""}/auth/callback?slug=${slug}` }
			});
	...
	async function loadForm() {
		...
		if (typeof window !== "undefined") console.log(`[Form Load] Loaded ${loadedQuestions.length} questions`, loadedQuestions.map((q) => ({
			label: q.label,
			type: q.type,
			config: q.config
		})));
		...
		for (const q of questions.filter((q) => FILE_TYPES.includes(q.type))) {
			...
			for (const file of files) {
				...
				if (upErr) {
					...
					const errorMsg = upErr.message?.includes("Payload too large") ? `${q.label}: ${file.name} is too large (max 10MB)` : upErr.message?.includes("bucket_not_found") ? `${q.label}: Upload service temporarily unavailable` : upErr.message?.includes("Network") ? `${q.label}: Network error - please check connection` : `${q.label}: ${file.name} - ${upErr.message || "upload failed"}`;
	...
	function renderAuthHeader() {
		if (authLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "flex items-center justify-center bg-secondary/20 rounded-lg px-4 py-6 border border-border/40",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-col items-center gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-5 w-5 animate-spin text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-muted-foreground",
					children: "Signing in with Google..."
				})]
			})
		});
		if (authSession) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center justify-between bg-primary/10 rounded-lg px-4 py-3 border border-primary/30",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "text-sm font-medium",
					children: [
						"Signed in as ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "font-semibold",
							children: authSession.name
						}),
						" (",
						authSession.email,
						")"
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-sm text-muted-foreground",
				children: "Sign in with Google to submit this form."
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
	...
	function renderSubmissionStatus() {
		...
		if (statusLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center gap-2 rounded-lg bg-secondary/20 px-4 py-3 border border-border/40",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin text-muted-foreground" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "text-sm text-muted-foreground",
				children: "Checking submission status..."
			})]
		});
		if (submissionStatus && submissionStatus.submission_count > 0) {
			const { submission_count, limit, can_submit } = submissionStatus;
			if (!can_submit) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "rounded-lg bg-amber-500/10 border border-amber-500/30 p-4",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-start gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-5 w-5 text-amber-600 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						className: "font-semibold text-sm text-amber-700",
						children: "You've reached the limit"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-start gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-5 w-5 text-blue-600 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						className: "font-semibold text-sm text-blue-700",
						children: "You've already submitted this form"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Shell, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mb-6",
				children: renderAuthHeader()
			}),
			authSession && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mb-6",
				children: renderSubmissionStatus()
			}),
			authSession && submissionStatus && !submissionStatus.can_submit && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "rounded-lg bg-background border-2 border-border/60 p-8 text-center",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-12 w-12 text-muted-foreground mx-auto mb-4" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "text-xl font-semibold mb-2",
						children: "No more submissions allowed"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-muted-foreground text-sm",
						children: "You have reached the maximum number of submissions for this form."
					})
				]
			}),
			authSession && submissionStatus && submissionStatus.can_submit && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [previewAuthorized && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					form.description && safeStep === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			!authSession && !statusLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "rounded-lg bg-blue-500/10 border border-blue-500/30 p-6 text-center",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						...
						children: "Please sign in with Google above to fill out and submit this form."
					})]
				})
			})
		]
...
function QuestionField({ question: q, value, error, onChange }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			FILE_TYPES.includes(q.type) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [typeof window !== "undefined" && (() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				children: isUploading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin" }), "Uploading..."] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, { className: "h-4 w-4" }), hasFile ? "Replace file" : "Upload file"] })
			}),
			(isUploading || uploadProgress > 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "space-y-1",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between text-xs text-muted-foreground",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Uploading..." }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [Math.round(uploadProgress), "%"] })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			files.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-2 text-xs text-muted-foreground bg-primary/5 p-2 rounded-lg",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-4 w-4 text-green-500 shrink-0" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "truncate max-w-xs flex-1",
						children: f.name
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",

...
import { H as ChevronUp, N as ExternalLink, O as GripVertical, T as LoaderCircle, U as ChevronDown, V as CircleAlert, W as Check, _ as Plus, a as Trash2, c as Smartphone, j as Eye, m as Save, q as ArrowLeft, t as X, x as Monitor, y as Palette } from "../_libs/lucide-react.mjs";
...
import { t as Route } from "./edit-BVZ2kcMR.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/edit-BiZ9lK6o.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							...
							children: "Maximum submissions from all respondents combined"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, {
						label: "Max responses per verified email",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
							value: form.responses_per_email_limit ?? "",
							onChange: (e) => onChange({ responses_per_email_limit: e.target.value ? parseInt(e.target.value) : null }),
							className: inputCls + " h-9",
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
									value: "10",
									children: "10 responses"
								})
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-xs text-muted-foreground mt-1",
							children: "Respondents must sign in with Google. Each verified email can submit up to this many times."
						})]
					}),

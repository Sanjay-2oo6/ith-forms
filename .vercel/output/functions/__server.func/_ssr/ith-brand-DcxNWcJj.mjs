...
//#region node_modules/.nitro/vite/services/ssr/assets/ith-brand-DcxNWcJj.js
...
var supabaseConfigError = missingEnv.length === 0 ? null : `Missing required environment variable${missingEnv.length > 1 ? "s" : ""}: ${missingEnv.join(", ")}. These must be set in the deployment's build environment (e.g. Netlify → Site settings → Environment variables, scope "Builds"), then redeploy with a cleared cache.`;

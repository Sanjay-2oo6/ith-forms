...
function PublicForm() {
  ...
  // Don't auto-trigger sign-in on page load
  // Let user see form first, then sign in when they try to submit
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (!authSession || !authSession.email) {
      ...
      // Trigger Google sign-in instead of just showing error
      console.log('[PublicForm] User not authenticated, initiating Google sign-in from submit');
      handleGoogleSignIn();
      return;
    }
